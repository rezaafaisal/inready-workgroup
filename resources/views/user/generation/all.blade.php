        ...
        <div class="flex justify-end mb-10">
            <form action="{{ route('all_generation') }}" method="get">
                <input
                    ...
                    type="search" name="keyword" id="keyword"
                ...
                <div class="overflow-hidden" data-aos="fade-up">
                    @if(Auth::user())
                        ...
                        <img src="{{ asset('profiles/'.$member->image) }}" alt=""
                            class="rounded-xl h-80 lg:h-60 w-full object-cover cursor-pointer" @click="show = true;detail('{{ $user }}')">
                    @else
                        <img src="{{ asset('profiles/'.$member->image) }}" alt=""
                    ...
                    <div class="py-3">
                        ...
                        <span class="block font-light mt-1">Angkatan
                            ke-{{ $member->generation?->name ?? '-' }}</span>
    ...
    <div x-show="show" class="z-10 w-screen overflow-hidden h-screen fixed top-0 left-0 right-0 bg-slate-500/50">
        <div class="z-20 fixed right-0 left-0 top-0 flex justify-center">
            <div @click.outside="show=false"
                class="mt-28 p-4 h-auto rounded-md bg-white shadow-md lg:w-6/12 md:w-9/12 w-10/12">
                ...
                <div class="pt-4 border-t border-gray-300 flex justify-end">
                    <button class="text-sm bg-inr-yellow px-10 py-2 rounded-full hover:bg-inr-yellow-1 duration-150"
